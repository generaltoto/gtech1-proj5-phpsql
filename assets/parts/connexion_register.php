      ...
      <form method="post" action="config/register.php">
        <div class="input-field row">
          <div class="col s12 m12 l6">
            ...
            <span class="red-text"><?php echo isset($_GET['firstNameErr'])?$_GET['firstNameErr']:''; ?></span>
          </div>
          <div class="col s12 m12 l6">
            <i class="fas fa-user"></i>
            <label for="lastName">Last Name</label>
            <input type="text" name="lastName">
            <span class="red-text"><?php echo isset($_GET['lastNameErr'])?$_GET['lastNameErr']:''; ?></span>
          </div>
          <div class="col s12">
          ...
          <div class="col s12 m12 l12 xl6">
            ...
            <span class="red-text"><?php echo isset($_GET['confirmPasswordErr'])?$_GET['confirmPasswordErr']:''; ?></span>
          </div>

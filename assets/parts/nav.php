...
<nav class="nav-wrapper z-depth-3">
  <div class="container">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <?php } elseif (isset($_SESSION['login']) && $_SESSION['login'] == true && $_SESSION['role'] == 0) { ?>
        ...
        <?php } elseif (isset($_SESSION['login']) && $_SESSION['login'] == true && $_SESSION['role'] == 2) { ?>
        ...
        <li><span> <?php echo (isset($_SESSION['login']) && $_SESSION['login'] == true) ? "Bonjour ".$bonjour : 'You are logged out'; ?> </span></li>  
      </ul>
  </div>
</nav>

<!-- dropdown structure  -->
<?php if(!isset($_SESSION['login'])) { // not logged in --> Log In & Register?> 
...
<?php } elseif (isset($_SESSION['login']) && $_SESSION['login'] == true && $_SESSION['role'] < 2) { // logged in but not admin --> Log Out ?>
  <ul id='dropdown_in' class='dropdown-content'>
    <li><a href="config/logout.php">Log Out</a></li>
  </ul>

<?php } elseif (isset($_SESSION['login']) && $_SESSION['login'] == true && $_SESSION['role'] == 2) { // logged in and admin --> Log Out & Admin ?>
...
<!-- dropdown strcture -->
<?php if(isset($_SESSION['login']) && $_SESSION['login'] == false) { // not logged in --> Log In & Register?> 
